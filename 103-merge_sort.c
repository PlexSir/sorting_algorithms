...
/**
 * merge_subarr - Sort a subarray of numbers.
 * @subarr: Subarray of an array of numbers to sort.
 ...
 * @subarr: Subarray of array of numbers to sort.
...
/**
 * merge_sort - Sort array of numbers in increasing
