 ...
 *                   list of numbers with node ahead of it.
 * @list: Pointer to head of a doubly-linked list of numbers.
 ...
 *                    list of numbers with node behind it.
 * @list: pointer to head of a doubly-linked list of numbers.
...
/**
 * cocktail_sort_list - Sort listint_t doubly-linked list of numbers in
